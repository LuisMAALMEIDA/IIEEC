...
Also, it can be attached all of the sets of wrenches affected by each actuator individually. Thus the $GWS_U$ can be given by the expression \eqref{eq:minkowski_actuator_wise}
